...
Includes evals, CI, installer, and a real before/after Flutter fixture. Feedback welcome:
...
The first release contains seven self-contained skills, evaluation rubrics, deterministic validation, a safe installer, and a real Flutter booking fixture with committed golden screenshots. The project is new and I am actively looking for rigorous feedback and contributors.
