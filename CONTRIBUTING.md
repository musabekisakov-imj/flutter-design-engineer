...
6. For demo changes, run `flutter analyze`, `flutter test --exclude-tags golden`, and local golden tests from `examples/booking-redesign/demo`; inspect every changed golden.
